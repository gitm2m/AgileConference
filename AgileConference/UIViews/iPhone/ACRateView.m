...
- (void)layoutSubviews {
    ...
    float imageWidth = 30;// MAX(_minImageSize.width, desiredImageWidth);
    float imageHeight = 30;// MAX(_minImageSize.height, self.frame.size.height);
