...
#define kSecondsInDay (60 * 60 * 24)
	if(sender == backButton) {
        ...
        if(forwardButton.isEnabled == NO)
            [forwardButton setEnabled:YES];
        if ([[dateFormatter stringFromDate:newDate] isEqualToString:@"17-02-2012"]) {
            [backButton setEnabled:NO];
        }else{
        ...
        if ([[dateFormatter stringFromDate:newDate] isEqualToString:@"19-02-2012"]) {
